...
#### 本地终端 (Local Terminal) 连接支持
- 新增 `local` 连接类型，支持本地终端登录
- 使用 `/usr/bin/login` 进行本地用户认证, 不存在则禁止连接

## 2026-01-23

### 新增功能

#### USB-Serial (ttyUSB) 连接支持
- 支持设备选择：ttyUSB0 ~ ttyUSB9
- 支持波特率配置：9600 / 19200 / 38400 / 115200 / 1500000
- 串口参数固定为 8N1（8数据位、无校验、1停止位）
